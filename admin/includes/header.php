   ...
   <nav class="col-sm-3 col-md-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'manageEmployee') { echo 'active'; } ?>" href="manageEmployee.php">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'manageUser') { echo 'active'; } ?>" href="manageUser.php">
