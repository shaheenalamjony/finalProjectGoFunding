...
session_start();
if(!isset($_SESSION['is_employeeLogin'])){
  if(isset($_REQUEST['email'])){
    ...
    $sql = "SELECT eEmail,ePassword from employee where eEmail = '{$email}' AND ePassword = '{$password}' limit 1";
    $result = mysqli_query($conn,$sql);
    if($result->num_rows == 1){
      $_SESSION['is_employeeLogin'] = true;
